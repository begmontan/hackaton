...
<body>
	...
	$edad_entrenador=$_GET["edad_entrenador"];
	$pokemon_entrenador=$_GET["pokemon_entrenador"];
	...
	$query = "INSERT INTO entrenador (NOMBRE_ENTRENADOR , APELLIDO_ENTRENADOR , EDAD_ENTRENADOR , POKEMON_ENTRENADOR) VALUES ('$nombre_entrenador','$apellido_entrenador', $edad_entrenador ,'$pokemon_entrenador')";
